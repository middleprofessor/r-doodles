...
The example is Figure 4b. The design is $2 \times 2$ factorial (two experimental factors each with two levels). I probably wouldn't communicate treatments this way but it does have the advantage that treatment combinations are easy to see even if the plot were black-and-white (but why would anyone use black and white in 2020?).
...
# A comparison with some other ways to communicate the factorial design
