...
If I'm going to evaluate the widespread use of t-tests/ANOVAs on count data in bench biology then I'd like to know what these data look like, specifically the shape ("overdispersion") parameter and zero-inflatedness.
...
plot_enteric <- function(fig_i, fig_num){
...
names(fig_list) <- c("fig1c", "fig1e", "fig1f", "fig2a", "fig2d", "fig3a", "fig3b", "fig4a", "fig5c", "fig6d")
