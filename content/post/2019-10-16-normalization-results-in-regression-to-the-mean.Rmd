...
Intuition 1: Step one of this normalization would seem to introduce a biased estimate of the effect, conditional on Gapdh, very similar to the biased estimate of the change score (or change from pre to post) conditional on pre-treatment values [in a pre-post design](https://www.middleprofessor.com/files/quasipubs/change_scores.html).
