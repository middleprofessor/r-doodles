...
4. Arguing that model averaging was developed for model-averaged predictions or that most of the theory applies to model-averaged predictions is not an argument against this rebuttal, only an argument that we need beed theoretical and empirical work on model-averaged coefficients.
