...
```{r}
cor(exp1.v1[Condition=="shScr" & Antibody=="Met", Value], exp1.v1[Condition=="shMet" & Antibody=="Met", gapdh_ref])
cor(exp1.v1[Condition=="shScr" & Antibody=="Met", Value], exp1.v1[Condition=="shScr" & Antibody=="Met", gapdh_ref])
cor(exp1.v1[Condition=="shScr" & Antibody=="pMet", Value], exp1.v1[Condition=="shMet" & Antibody=="pMet", gapdh_ref])
cor(exp1.v1[Condition=="shScr" & Antibody=="pMet", Value], exp1.v1[Condition=="shScr" & Antibody=="pMet", gapdh_ref])

cor(exp1.v1[Condition=="shScr" & Antibody=="Met" & Type=="Cells", Value], 
    exp1.v1[Condition=="shMet" & Antibody=="Met" & Type=="Cells", gapdh_ref])
cor(exp1.v1[Condition=="shScr" & Antibody=="Met" & Type=="Cells", Value], 
    exp1.v1[Condition=="shScr" & Antibody=="Met" & Type=="Cells", gapdh_ref])
cor(exp1.v1[Condition=="shScr" & Antibody=="pMet" & Type=="Cells", Value],
    exp1.v1[Condition=="shMet" & Antibody=="pMet" & Type=="Cells", gapdh_ref])
cor(exp1.v1[Condition=="shScr" & Antibody=="pMet" & Type=="Cells", Value], 
    exp1.v1[Condition=="shScr" & Antibody=="pMet" & Type=="Cells", gapdh_ref])
...
#### No expected correlation between Gapdh level and either control or treatment level
```{r}
...
#### Expected correlation between Gapdh level and either control or treatment level is 0.5
