...
8. The difference in predicted values computed on the link vs. response scale is trivially small for the example below, and probably in most real examples so in a sense, our argument doesn't really matter. There are much bigger sources of error in modeling than this.
