---
title: paried t-test as a special case of linear model and hierarchical (linear mixed)
  model
author: Jeff Walker
date: '2019-06-25'
slug: paried-t-test-as-a-special-case-of-linear-model-and-hierarchical-linear-mixed-model
categories:
  - stats 101
tags:
  - linear mixed model
...
paired t-test as linear model and as linear mixed model. Because of the cross-over design, the ID is not in order within each level of treatment. Make a wide data table with new treatment columns matched by ID.
