...
fig1f[, platelets_orig := round(platelets*10^9)]
```


```{r fig1f}
fig1f_means <- fig1f[, .(platelets = mean(platelets),
                         SD = sd(platelets),
...
# Bootstrap CIs
```{r}
m1 <- lm(platelets ~ treatment, data = fig1f)
...
```{r}
plot_grid(gg_raw, gg_boot, ncol=2)
```
...
```{r summary-results-normal, echo=FALSE}

knitr::kable(boot_ci_sim_nb$coverage_table_mu, caption = "Coverage of the estimate of the mean, for data sampled from a negative binomial distribution")
knitr::kable(boot_ci_sim_nb$coverage_table_beta, caption = "Coverage of the estimate of the difference in means, for data sampled from a negative binomial distribution")

knitr::kable(boot_ci_sim_normal$coverage_table_mu, caption = "Coverage of the estimate of the mean, for data sampled from normal distribution")
knitr::kable(boot_ci_sim_normal$coverage_table_beta, caption = "Coverage of the estimate of the difference in means, for data sampled from a normal distribution")

```

Huh. Yes, books on the bootstrap do cover small sample issues and potential solutions. But I'm surprised by how little I've seen references to this, or maybe I've just selectively filtered it out.